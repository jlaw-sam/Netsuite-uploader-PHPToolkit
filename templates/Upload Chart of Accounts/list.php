...
<div class="uk-overflow-auto">
    <table class="uk-table uk-table-hover uk-table-striped uk-table-middle uk-table-divider uk-table-responsive">
        ...
        <tbody>
         ...
         ?>
            <tr class="data<?php echo $records->internalId; ?>">
                ...
                <td>
                    <ul class="uk-iconnav">
                        <li><a uk-icon="icon: copy" uk-tooltip="title: View Details; pos: bottom"></a></li>
                        <li><a uk-icon="icon: file-edit" uk-tooltip="title: Edit; pos: bottom"></a></li>
                        <li><a uk-icon="icon: trash" uk-tooltip="title: Delete; pos: bottom" href="#modal-delete-single<?php echo $records->internalId; ?>" uk-toggle></a></li>
                    </ul>
                    <div id="modal-delete-single<?php echo $records->internalId; ?>" uk-modal>
                        <div class="uk-modal-dialog">
                            <button class="uk-modal-close-default" type="button" uk-close></button>
                            <div class="uk-modal-header">
                                <h3>Delete Internal ID `<?php echo $records->internalId; ?>`</h3>
                            </div>
                            <div class="uk-modal-body">
                                <p class="uk-text-danger">Are you sure you want to Delete<br>Internal ID `<?php echo $records->internalId; ?>`?</p>
                            </div>
        ...
        <?php } ?>
        <tr>
        	<td colspan="8"><button class="uk-button uk-button-danger" href="#modal-delete" uk-toggle>Delete Selected Records</button></td>
